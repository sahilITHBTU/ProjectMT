...
import { getReplacement, escapeRegex } from "./replace.js";
/**
 ...
 */
export function expandReplacement(template, { match, captures, offset, haystack, groups }) {
 ...
 */
export async function replaceStreamAsync(source, from, to, config) {
